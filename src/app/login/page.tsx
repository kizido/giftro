...
export default function Login() {
  return (
    <div className="w-full min-w-48 p-4 pt-6 md:pt-24 flex flex-col md:flex-row items-center md:items-start justify-center gap-2 md:gap-8">
      <div className="w-full max-w-[28rem] p-2 flex flex-col gap-2">
        ...
        <div className="flex justify-between">
          ...
          <Link href="/forgotpassword" className="text-sm text-blue-700 underline">
            Forgot password?
          </Link>
        </div>
