...
export default async function Home() {
  ...
  return (
    <main>
      <div className="w-full px-16 py-16 flex items-center justify-center flex-col bg-slate-400 gap-8">
      ...
      <div className="w-full px-16 py-16 flex items-center justify-center bg-slate-700 gap-12">
        <h1 className="w-1/3 text-8xl">
          Duis fringilla laoreet odio lobortis aliquam
        </h1>
        <h1 className="w-2/3 text-4xl">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
          interdum velit non condimentum sollicitudin. Morbi id ante ipsum.
          Fusce in iaculis justo, sit amet aliquet lorem. Donec at pretium
          dolor. Sed convallis, arcu vitae eleifend tristique, ex purus gravida
