...
exports.GetItemsRequest = void 0;
...
var GetItemsRequest = /** @class */ (function (_super) {
    ...
    function GetItemsRequest(payload) {
        ...
        _this.path = '/paapi5/getitems';
        _this.target = 'com.amazon.paapi5.v1.ProductAdvertisingAPIv1.GetItems';
        return _this;
    }
    GetItemsRequest.prototype._buildPayload = function () {
