...
export declare type Features = MultipleValuesAttribute<string, 'Features'>;
...
export declare type Title = SingleValueAttribute<string, 'Title'>;
...
export declare type ItemInfoResource = Resources<ItemInfo, 'ItemInfo.'>;
